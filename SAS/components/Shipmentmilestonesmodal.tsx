...
interface Shipment {
  ...
  destination_country_code: string | null; pickup_date_status: string | null;
            ...
            <div>
              <div style={{ display:'flex', alignItems:'center', gap:8, marginBottom:4 }}>
                ...
                {shipment?.pickup_date_status && (
                  <span style={{ fontSize:11, fontWeight:700, padding:'2px 9px', borderRadius:99, background: shipment.pickup_date_status==='Delayed'?'#FEE2E2':'#D1FAE5', color: shipment.pickup_date_status==='Delayed'?'#B91C1C':'#065F46', border: shipment.pickup_date_status==='Delayed'?'1px solid #FECACA':'1px solid #A7F3D0' }}>
                    {shipment.pickup_date_status}
                  </span>
                )}
              </div>
