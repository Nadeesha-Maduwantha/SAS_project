    ...
    <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6 mb-5">
      ...
      <div className="space-y-2">
        {[
          ...
          { key: "notifyNewUserCreated",    label: "Notify when a new user account is created" },
          { key: "notifyUserAccountSuggested", label: "Notify when a new email needs a user account created" },
        ].map((item) => (
