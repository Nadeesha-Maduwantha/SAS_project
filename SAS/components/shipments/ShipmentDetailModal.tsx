...
// progress map — uses the real CargoWise llmIdentifiedType values to map
// each CargoWise stage to a percentage for the progress bar.
...
const PICKUP_COLOR_MAP: Record<string, { bg: string; color: string; border: string }> = {
...
export default function ShipmentDetailModal({ isOpen, onClose, shipment }: ShipmentDetailModalProps) {
  ...
  const pickupStatusColors = shipment.pickupDateStatus
    ? (PICKUP_COLOR_MAP[shipment.pickupDateStatus] ?? { bg: '#f9fafb', color: '#6b7280', border: '#e5e7eb' })
    ...
    >
      ...
      >
        ...
        <header style={{
          ...
          padding: '20px 24px', borderBottom: '1px solid #e5e7eb', backgroundColor: '#ffffff',
        } as React.CSSProperties}>
          <div>
        ...
        <div style={{ flex: 1, overflowY: 'auto', padding: '24px' } as React.CSSProperties}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '20px', alignItems: 'start' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: '16px' }}>
                  <div>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '4px' }}>
                      ...
                      <h3 style={{ fontSize: '14px', fontWeight: 600, color: '#111827', margin: 0 }}>Current Status</h3>
                    </div>
              ...
              {/* Route Details */}
              <div style={{ background: 'white', borderRadius: '12px', border: '1px solid #e5e7eb', padding: '20px', boxShadow: '0 1px 3px rgba(0,0,0,0.06)' }}>
                <h3 style={{ fontSize: '14px', fontWeight: 600, color: '#111827', margin: '0 0 16px' }}>Route Details</h3>
              ...
              {/* Cargo Timeline */}
              <div style={{ background: 'white', borderRadius: '12px', border: '1px solid #e5e7eb', padding: '20px', boxShadow: '0 1px 3px rgba(0,0,0,0.06)' }}>
                <h3 style={{ fontSize: '14px', fontWeight: 600, color: '#111827', margin: '0 0 16px' }}>Cargo Timeline</h3>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
              ...
              {/* CargoWise Details */}
              <div style={{ background: 'white', borderRadius: '12px', border: '1px solid #e5e7eb', padding: '20px', boxShadow: '0 1px 3px rgba(0,0,0,0.06)' }}>
                <h3 style={{ fontSize: '14px', fontWeight: 600, color: '#111827', margin: '0 0 14px' }}>CargoWise Details</h3>
