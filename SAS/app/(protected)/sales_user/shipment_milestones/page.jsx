            ...
            {shipment?.milestones?.cargo_pickup?.status && (
              <>
                ...
                <span style={{
                  ...
                  background: shipment.milestones.cargo_pickup.status.toLowerCase().includes("overdue") ? "#fef2f2" : "#f0fdf4",
                  color:      shipment.milestones.cargo_pickup.status.toLowerCase().includes("overdue") ? "#dc2626" : "#15803d",
                  border:     shipment.milestones.cargo_pickup.status.toLowerCase().includes("overdue") ? "1px solid #fecaca" : "1px solid #bbf7d0",
                }}>
                  {shipment.milestones.cargo_pickup.status}
                </span>
              </>
