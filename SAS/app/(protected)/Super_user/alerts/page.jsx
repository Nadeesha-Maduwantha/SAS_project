...
export default function AlertDashboardPage() {
    ...
    const statsCards = [
        { icon: <AlertCircle size={26} color="#ef4444" />, iconBg: '#fef2f2', count: 14, label: 'High Priority Alerts', borderColor: '#fca5a5' },
        { icon: <Clock       size={26} color="#f97316" />, iconBg: '#fff7ed', count: 42, label: 'Pending Review',        borderColor: '#fdba74' },
        { icon: <CheckCircle2 size={26} color="#22c55e"/>, iconBg: '#f0fdf4', count:  8, label: 'Resolved Today',        borderColor: '#86efac' },
    ];
                ...
                {statsCards.map((card) => (
                    <div key={card.label} style={{
                        ...
                        <div style={{
                            ...
                            background: card.iconBg, border: `1px solid ${card.borderColor}`,
            ...
            <div style={{ background: 'white', borderRadius: '12px', boxShadow: '0 1px 4px rgba(0,0,0,0.06)', border: '1px solid #f0f0f0', overflow: 'hidden' }}>
                        ...
                        <div key={f.label} style={{ position: 'relative' }}>
                            <select
                                ...
                                style={{
                                    ...
                                    padding: '7px 30px 7px 12px', fontSize: '13px',
                            ...
                            <tbody>
                                {filtered.map((alert, idx) => (
                                    ...
                                    >
                                        ...
                                        <td style={{ ...tdStyle, fontWeight: 600, fontSize: '13px', color: '#374151', whiteSpace: 'nowrap' }}>{alert.id}</td>
                ...
                {viewMode === 'cards' && (
                    <div style={{ padding: '20px', display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(300px, 1fr))', gap: '14px' }}>
                        {filtered.map((alert) => (
                            <div key={alert.id} style={{ border: '1px solid #e8ecf0', borderRadius: '10px', padding: '16px', background: 'white', boxShadow: '0 1px 3px rgba(0,0,0,0.04)' }}>
...
const thStyle = {
    ...
    fontWeight: 600, color: '#9ca3af', letterSpacing: '0.05em',
...
function PageBtn({ label, icon, right }) {
    return (
        <button style={{
            ...
            fontWeight: 500, flexDirection: right ? 'row-reverse' : 'row',
        }}>
            {icon}{label}
        </button>
    );
