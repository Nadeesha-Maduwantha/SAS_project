...
const ROLE = "admin"; // change per user folder
...
export default function CurrentMilestonePage() {
  ...
  const [filter,  setFilter]  = useState("all"); // "all" | "overdue" | "pending" | "none"

  useEffect(() => {
    fetch("http://127.0.0.1:5000/api/shipments/current-milestones")
    .then(r => {
